    ...
    <nav className="stick w-full h-20 z-10 px-10 md:px-20 py-5 top-0 flex items-center justify-between gap-12 border-b border-stone-200 bg-white">
      ...
      >
        <input
          type="text"
          placeholder="Search..."
          className="w-full md:w-1/4 p-4 md:pl-12 bg-stone-200 rounded-full placeholder:text-stone-500 placeholder:text-sm md:placeholder:text-md focus:bg-transparent"
        />
